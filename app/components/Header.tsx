...
export default function Header() {
    ...
    return (
        <header className="sticky px-25 py-10 top-0 z-50 flex h-16 w-full items-center justify-between border-b border-slate-100 bg-white">
            ...
            {/* 1. LEFT ZONE: BRAND LOGO & SEARCH */}
            <div className="flex flex-1 items-center gap-6 w-1/2">
                {/* Brand Logo Wrapper */}
                ...
                <div className="relative hidden max-w-md flex-grow sm:block">
                    ...
                    <input
                        ...
                        className="w-full rounded-full bg-[#F5F5F5] py-2 pl-11 pr-4 text-md text-slate-700 outline-none border border-[#cccccc] placeholder-slate-400  focus:bg-white transition-all focus:border-blue-500 focus:outline-none focus:ring-0 focus:ring-blue-500"
                    />
                </div>
            </div>
            ...
            <div className="flex items-center justify-end gap-12 w-1/2" ref={dropdownRef}>
                ...
                <button className="relative flex h-full items-center justify-center px-2 text-slate-800 hover:text-[#1890FF] transition-colors duration-150 cursor-pointer group">
                    <svg
                ...
                <button className="relative flex h-full items-center justify-center px-2 text-slate-800 hover:text-[#1890FF] transition-colors duration-150 cursor-pointer group">
                    ...
                    <span className="absolute -top-[20px] -right-1 flex h-4 w-4 items-center justify-center rounded-full bg-[#1890FF] text-[10px] font-bold text-white">
                        6
                    </span>
                    <div className="absolute -bottom-[30px] inset-x-0 h-[3px] bg-[#1890FF] rounded-t-full opacity-0 group-hover:opacity-100 transition-opacity duration-150"></div>
                </button>
